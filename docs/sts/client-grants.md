...
> Obtaining client ID and secrets follow [Keycloak configuring documentation](https://github.com/kypello-io/kypello/blob/master/docs/sts/keycloak.md)
