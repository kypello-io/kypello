...
docker run \
  ...
  quay.io/minio/kypello server /data --console-address ":9001"
```
...
```
docker service create --name="minio-service" --secret="access_key" --secret="secret_key" quay.io/minio/kypello server /data
```
...
docker service create --name="minio-service" \
  ...
  quay.io/minio/kypello server /data
```
